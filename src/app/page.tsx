...
import CodeExamples from "~/components/client/code-example";
    ...
    <div className="min-h-screen bg-white">
      <nav className="flex h-16 items-center justify-between border-b border-gray-200 px-10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-medium"><strong>SentimentA </strong> -A video sentiment analysis tool trained using MELD dataset</span>
        </div>
